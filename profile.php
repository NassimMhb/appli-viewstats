            ...
            <div class="row content-panel">
              <div class="col-md-4 profile-text mt mb centered">
                <div class="right-divider hidden-sm hidden-xs">
                  <h4>1922</h4>
                  <h6>Nombre d'agents</h6>
                  <h4>290</h4>
                  <h6>Nombre de commerçants</h6>
                  <h4>$ 13,980</h4>
                  <h6>Total chiffres d'affaires réunis</h6>
                </div>
              </div>
              <!-- /col-md-4 -->
              <div class="col-md-4 profile-text">
                <h3>Nassim Mouhoubi</h3>
                <h6>Administrateur principal</h6>
                <p>L'administrateur a une vue sur l'ensemble de l'application. Celle-ci réunie les données des agents mais aussi les statistiques concernant les commerçants.</p>
                <br>
              </div>
              <!-- /col-md-4 -->
